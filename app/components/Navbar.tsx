  ...
  return (
    <div className="flex items-center justify-between p-4">
      ...
      <div className="flex items-center gap-6 justify-end w-full">
        ...
        <div className="relative bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer hover:text-gray-500">
          <svg
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
        ...
        <div className="cursor-pointer text-purple-600 hover:text-purple-800 border-2 border-purple-600 hover:border-purple-800 rounded-full">
          <svg
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
